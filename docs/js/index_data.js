...
function setSceneUserNum(data) {
	...
	data.data.forEach(function(v, i) {
		var temp = `<li>
			<ul>
				<li class="placeIcon" style="background-image: url(${basePath + v.icon})"></li>
		...
		var temp = `<li data-id="${v.sceneCode}">
			...
			<div class="stationDetail">
				<div class="stationName">
					<i></i>
					<b style="background-image: url(${basePath + v.icon})"></b>
					<p>${v.sceneName}</p>
				</div>
				<div class="percent">
					<div class="totalCount">
	...
	data.data.forEach(function(v, i) {
		...
		v.spList.forEach(function(value, index) {
			var temp = `<li data-id="${value.spCode}">
				<span class="newsIcon">
					<i style="background-image: url(${basePath + value.icon})"></i>
				</span>
